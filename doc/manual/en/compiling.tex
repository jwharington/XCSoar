...
\item \href{http://developer.android.com/sdk/ndk/}{Android NDK r20-beta3}
...
\verb|~/opt/android-ndk-r20-beta3|.  You can use the options
...
for the Kobo Aura, the branch is called "kobo-aura",
for the Kobo Aura~2, the branch is called "kobo-aura2",
for the Kobo Glo HD, the branch is called "kobo-glohd".
...
directory in XCSoar's \texttt{git} repository. For the Kobo Mini and Kobo Aura, install a
...
To compile a kernel image for the Kobo Mini or Aura, type:
...
\texttt{uImage.otg}, \texttt{uImage.kobo}, 
\texttt{uImage.aura.otg}, \texttt{uImage.aura}, 
\texttt{uImage.aura2.otg}, \texttt{uImage.aura2}, 
\texttt{uImage.glohd.otg} and \texttt{uImage.glohd} 
to \texttt{/opt/kobo/kernel}.
