...
TEST_REPLAY_TASK_DEPENDS = TASKFILE ROUTE WAYPOINT GLIDE LIBNMEA GEO MATH IO OS UTIL TIME UNITS DATA
...
RUN_MULTI_AIRCRAFT_SOURCES = \
	...
	$(TEST_SRC_DIR)/MultiAircraft/FlightReconstructionFilter.cpp \
...
RUN_MULTI_AIRCRAFT_DEPENDS = DRIVER LIBNET IO OS THREAD TIME DATA JSON ZZIP
...
RUN_ANALYSIS_DEPENDS = \
	...
	ROUTE AIRSPACE ZZIP UTIL GEO MATH TIME DATA
