...
SystemWidget::SwitchKernel()
{
  ...
  if (model != KoboModel::MINI &&
      model != KoboModel::AURA &&
      model != KoboModel::GLO &&
      model != KoboModel::TOUCH2 &&
      model != KoboModel::GLO_HD &&
      model != KoboModel::AURA2 &&
      ShowMessageBox(_T("This feature was designed for the Kobo Mini, Touch 2.0, Glo HD, Aura and Aura 2, but this is not one.  Use at your own risk.  Continue?"),
  ...
  case KoboModel::TOUCH2:
    ...
    break;
  case KoboModel::AURA:
    otg_kernel_image = "/opt/xcsoar/lib/kernel/uImage.aura.otg";
    kobo_kernel_image = "/opt/xcsoar/lib/kernel/uImage.aura";
    break;
