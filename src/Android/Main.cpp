                                            ...
                                            jint sdk_version, jstring product)
{
  ...
  is_eink = is_dithered || is_nook || IsKobo()
      || StringIsEqual(native_view->GetProduct(), "HLTE203T") // Hisense A5 pro CC
      || StringIsEqual(native_view->GetProduct(), "HNR320T"); // Hisense A7 CC
#endif
